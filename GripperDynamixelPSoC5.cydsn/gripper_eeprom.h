...
#define EEPROM_ADDR_GRIPPER_RIGHT_MOTOR_CW_MARGIN_L   5
#define EEPROM_ADDR_GRIPPER_RIGHT_MOTOR_CW_MARGIN_H   6
#define EEPROM_ADDR_GRIPPER_RIGHT_MOTOR_CCW_MARGIN_L  7
#define EEPROM_ADDR_GRIPPER_RIGHT_MOTOR_CCW_MARGIN_H  8
#define EEPROM_ADDR_GRIPPER_LEFT_MOTOR_CW_MARGIN_L    9
#define EEPROM_ADDR_GRIPPER_LEFT_MOTOR_CW_MARGIN_H    10
#define EEPROM_ADDR_GRIPPER_LEFT_MOTOR_CCW_MARGIN_L   11
#define EEPROM_ADDR_GRIPPER_LEFT_MOTOR_CCW_MARGIN_H   12


#define MOTOR_LEFT_MARGIN_CW    0
#define MOTOR_LEFT_MARGIN_CCW   1
#define MOTOR_RIGHT_MARGIN_CW   2
#define MOTOR_RIGHT_MARGIN_CCW  3

extern uint16 motorMargin[4];
